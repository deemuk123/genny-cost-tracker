...
interface GeneratorStore {
  ...
  // Data setters for API integration
  setGenerators: (generators: Generator[]) => void;
  setHourReadings: (readings: HourMeterReading[]) => void;
  setFuelPurchases: (purchases: FuelPurchase[]) => void;
  setFuelIssues: (issues: FuelIssue[]) => void;
  setFuelStock: (stock: FuelStock) => void;
  setMonthlyStockChecks: (checks: MonthlyStockCheck[]) => void;
}
...
export const useGeneratorStore = create<GeneratorStore>((set, get) => ({
  ...
  setHourReadings: (hourReadings) => set({ hourReadings }),
  setFuelPurchases: (fuelPurchases) => set({ fuelPurchases }),
  setFuelIssues: (fuelIssues) => set({ fuelIssues }),
  setFuelStock: (fuelStock) => set({ fuelStock }),
  setMonthlyStockChecks: (monthlyStockChecks) => set({ monthlyStockChecks }),
